...
class ResNet_v12:
    def __init__(self, epochs=40, batch_size=128, load_weights=True,level="32",transfer=False,x_train=None,y_train=None,x_val=None,y_val=None,loss_fn=None,istransfer=False):
        self.name               = 'resnet_'+level+'_fusion_diversity_lessdiv_strongforhigher321v2_avg_mean' #'resnet_cifar10' if dataset=='cifar10'  else 'resnet_mnist'
        ...
        self.log_filepath       = r'logs/v12_mean/'
