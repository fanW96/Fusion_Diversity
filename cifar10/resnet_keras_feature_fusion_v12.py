...
class ResNet_v12:
    def __init__(self, epochs=600, batch_size=128, load_weights=True,level="32",transfer=False,x_train=None,y_train=None,x_val=None,y_val=None,loss_fn=None,istransfer=False):
        self.name               = 'resnet_'+level+'_fusion_diversity_final_avg_600' #'resnet_cifar10' if dataset=='cifar10'  else 'resnet_mnist'
...
#         sgd = optimizers.SGD(lr=0.01, momentum=0.9, nesterov=True) # momentum-动量法,nesterov-NAG
        ...
        cbks = [ tb_cb, plot_callback, change_lr]
        ...
        self._model.save('models/'+self.name+'_weight_final'+'.h5')
        self.param_count = self._model.count_params()
