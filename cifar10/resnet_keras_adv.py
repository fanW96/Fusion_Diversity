...
class ResNet_adv:
    def __init__(self, epochs=180, batch_size=128, load_weights=False, level="32", transfer=False, x_train=None, y_train=None, x_val=None, y_val=None, loss_fn=None, attack_method=None):
