...
class ResNet_v12_adv:
    def __init__(self, epochs=180, batch_size=100, load_weights=False, level="32", transfer=False, x_train=None, y_train=None, x_val=None, y_val=None, loss_fn=None, attack_method=None):
        ...
        self.log_filepath = r'logs/v12_adv/'
