...
class ResNet_v13:
    def __init__(self, epochs=180, batch_size=128, load_weights=True,level="32",transfer=False,x_train=None,y_train=None,x_val=None,y_val=None,loss_fn=None,istransfer=False):
        self.name               = 'resnet_'+level+'_light_fusion_diversity_lessdiv_strongforhigher321v2_avg' #'resnet_cifar10' if dataset=='cifar10'  else 'resnet_mnist'
    ...
    def residual_network(self, img_input,classes_num=10,stack_n=5):  # ResNet参数，但不包括weights
        ...
        # 8*8*128
        p1 = Conv2D(64, kernel_size=(1, 1), strides=(2, 2), padding='same')(p1)
        ...
        # 8*8*128
        p2 = Conv2D(64, kernel_size=(1, 1), strides=(2, 2), padding='same')(p2)
